...
func TestPrecedence_CLIOverridesEnv(t *testing.T) {
	// Set env vars
	_ = os.Setenv("NATS_URL", "nats://env-default:4222")
	_ = os.Setenv("TIMESCALE_DSN", "postgres://env-default/db")
	_ = os.Setenv("STRATA_API_ADDR", ":9090")
	_ = os.Setenv("STRATA_TUNNEL_ADDR", ":9091")
	_ = os.Setenv("STORAGE_BACKEND", "s3")
	_ = os.Setenv("STORAGE_BUCKET", "env-bucket")
	_ = os.Setenv("STORAGE_REGION", "us-east-1")
	_ = os.Setenv("STORAGE_ENDPOINT", "https://env.example.com")
	defer func() {
		_ = os.Unsetenv("NATS_URL")
		_ = os.Unsetenv("TIMESCALE_DSN")
		_ = os.Unsetenv("STRATA_API_ADDR")
		_ = os.Unsetenv("STRATA_TUNNEL_ADDR")
