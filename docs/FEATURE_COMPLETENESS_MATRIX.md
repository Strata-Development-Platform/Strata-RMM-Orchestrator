...
| 6 | Core Technical Documentation | `docs/architecture/policy-engine.md` (override precedence + ASCII diagram), `docs/integrations/public-api.md` (OpenAPI 3.0 spec for EDR/Backup/PSA), `docs/monitoring/best-practice-templates.md` (server/hardware template master tables with OIDs and thresholds) | **Partial** — 6.1 exists, 6.2 (PR #70, 84 pass), 6.3 not started | `docs/architecture/`, `docs/integrations/`, `docs/monitoring/` |
